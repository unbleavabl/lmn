  ...
  exterior: {
    ...
    data: [
            ...
            options: [
              {
                name: 'Gable',
                description:
                  'Two roof sections sloping in opposite directions, placed such that the highest horizontal edge meet to form the roof ridge.',
                image: 'images/roofs/types/gable.jpg',
              },
              {
                name: 'Flat',
              ...
              },
              {
                name: 'Saltbox',
                description:
                  'A saltbox roof is an asymmetrical gable-style roof. The front side is usually short with a slight slope, while the rear side is long.',
              ...
              },
              {
                name: 'Gambrel',
                description:
                  'A gambrel or gambrel roof is a symmetrical two-sided roof with two slopes on each side. The upper slope is positioned at a shallow angle, while the lower slope is steep.',
      ...
      },
      {
        ...
        typeTitle: 'Roof Surface & Components',
        types: [
          {
            name: 'Roof covering',
            ...
            options: [
              {
                name: 'Metal cladding',
                description:
                  'Metal Roofing panels can be constructed of aluminum, zinzalume, copper, galvanized steel, or stainless steel.  Metal roofs are light weight, long lasting, but susceptible to hail and wind damage.',
              ...
              },
              {
                ...
                description:
                  'Ceramic tiles made of clay or shale with a long lifespan and resistance to weather. These tiles typically interlock in a mission or barrel pattern for a wavy appearance but can also be flat. These tiles are held in place with nails and motar.',
                image: 'images/roofs/cladding/clay-tile.jpg',
              },
              {
                name: 'Slate roofing',
                description:
                  'Slate is a natural tile that can last for up to 100 years and is resistant to wind, hail, and fire. Synthetic slate roofs made of asphalt, aluminum, or plastic resins are more common than the actual stone.',
                image: 'images/roofs/cladding/slate-tile.jpg',
              },
              {
                name: 'Wood shakes',
                description:
                  'Roof surface that is made from split pieces of wood, usually 18”-24” long, 6”-10” wide, and 1/2” thick. Felt is installed under the shakes. Wood shakes can last for 15-50 years depending on the climate and maintenance. They are subject to deterioration like any other exterior wood products.',
                image: 'images/roofs/cladding/wood-shake.jpg',
              },
              {
                name: 'Wood Shingles',
                description:
                  'Roof surface made from cut pieces of wood with a 5” – 10” exposure. Unlike shakes, shingles have same dimensions and are uniform in appearance. Wood shingles can last for 15-50 years depending on the climate and maintenance. They are subject to deterioration like any other exterior wood products.',
                image: 'images/roofs/cladding/wood-shingle.jpg',
              },
              {
                name: 'Modified Bitumen Roofing',
                description:
                  'Roof surface is created by using a combination of asphalt, rubber, plastic, and fiberglass. This roof type is made of sturdy and flexible material and can be used for low slope and flat roof surfaces. Typically, it is rolled in place and adhered to the roll next to it using hot tar. Mod-Bit is resistant to damage and can be repaired depending on the size and location of the damage.',
                image: 'images/roofs/cladding/modified-bitumen.jpg',
              },
              {
                name: 'Rolled Roofing',
                description:
                  'Asphalt material comes in rolls and is applied on low-slope or flat roof surfaces. This material is typically installed over felt and overlaps the roll below it. The Rolled roof material is similar to that used in 3-Tab shingles and also has similar life expectancy.',
                image: 'images/roofs/cladding/rolled-roofing.jpg',
              },
            ],
          },
          {
            name: 'Types of Roof Vents',
            image: 'images/roofs/vents/turtle.jpg',
            options: [
              {
                name: 'Turbine vent',
                description:
                  'These vents are made of aluminum or galvanized steel and may be painted on site or come with a factory paint finish. Turbine vents are susceptible to hail damage.',
                image: 'images/roofs/vents/turbine.jpeg',
              },
              {
                name: 'Furnace vent',
                description:
                  'Allows heat from an appliance exhaust to escape through the roof. These vents typically have a pipe and storm collar and a cap component. The top is called a rain cap and can be replaced separately. Typically come in 5", 6", or 8" sizes.',
              ...
              },
              {
                name: 'Turtle vent',
                description:
                  'A square shaped vent resembling a turtle’s shell that allows hot air to escape the attic. Also called a box vent. They are typically made of aluminum, but can also be made of aluminum, plastic, or galvanized steel.',
                image: 'images/roofs/vents/turtle.jpg',
              },
              {
                name: 'Ridge vent',
                description:
                  "A vent installed on the ridges of the roof to allow air to escape.. As the ridges are at the roof's highest points, the warm air rises out through the vent. The most common styles are aluminum or shingle-over style. The shingle-over style is a plastic cap installed on the ridge with ridge cap shingles installed through the top of the vent.",
                image: 'images/roofs/vents/ridge.jpg',
              },
              {
                name: 'Pipe Jack Flashing',
                description:
                  'Pre-formed collar (metal or plastic) is fitted over a plumbing exhaust pipe on the roof. The collar has a rubber gasket that grips the pipe to prevent water from entering. Lead pipe jack is fitted around the pipe for a waterproof seal.',
                image: 'images/roofs/vents/pipejack.jpg',
              },
              {
                name: 'Split Boot Flashing',
                description:
                  'A split-boot flashing is split at one end to allow it to be sized correctly to the pipe it will stick. The boot is cut to the point that it is tight against the pipe and then glued together using a rubber adhesive. Commonly installed around electrical mastheads to the entire apparatus so that it does not have to be removed to replace the flashing component.',
                image: 'images/roofs/vents/splitboot.jpg',
              },
              {
                name: 'Gable Attic Vent',
                description:
                  'Gable attic vents allow air to flow through the attic instead of just up and out. These vents are installed in the middle of the gable portion of an elevation and are typically made up of the same material as the siding. The vents typically have a mesh backing to prevent rodents and bugs from entering the attic space.',
            ...
            options: [
              {
                name: 'Satellite Dish',
                description:
                  'Personal satellite dishes may be used for Internet access or for television reception. Satellite dishes that are in an area needing replacement will need to be detached and reset. Homeowners typically do not own the equipment.',
                image: 'images/roofs/satellite/satellite-dish.jpg',
              },
            ],
          },
            ...
            options: [
              {
                name: 'Skylight',
                description:
                  'Windows installed in the roof to provide light and ventilation into the home. Skylights are prone to leaks and the flashing and cladding are susceptible to hail damage. May be flat or domed shaped and made of glass or plastic and come in various sizes.',
                image: 'images/roofs/skylight/skylight.jpg',
              },
            ],
          },
      ...
      },
      {
        ...
        description:
          'Exterior doors are typically made up of wood, fiberglass, or metal. Non-wood exterior doors will be insulated to protect the interior from the elements such as hail, wind driven debris, or fire. Doors come in many grades and styles.',
            ...
            options: [
              {
                name: 'Full lite exterior door',
                description:
                  'Is an upgraded exterior door with two side-lites and overhead transom, as it enhances the overall aesthetic of the house and helps to pass sufficient sunlight into the house.',
                image: 'images/doors/full-lit-exterior-door.jpg',
              },
            ],
          },
            ...
            options: [
              {
                name: 'French door',
                description:
                  'A French door is usually a higher end door assembly which includes double/multiple full lite doors can be used on the exterior or the interior and on the exterior, it is usually used in place of a sliding patio door.',
                image: 'images/doors/french-door.jpg',
              },
            ],
          },
            ...
            options: [
              {
                name: 'Window Screen',
                description:
                  'Window screens primarily maintain the view and airflow while protecting against insects from flying or crawling inside the house.',
                image: 'images/window-components/window-screen.jpg',
              },
            ],
          },
            ...
            options: [
              {
                name: 'Board fence',
                description:
                  'Board fencing is constructed using a center section (panel) made with wood slats mounted to 2x4 rails. These panels are then attached to wood or metal post typically installed 8’ on center. If damage is only to the paint or stain, it can be power washed and refinished for a proper repair. If unstained, no repair is necessary.',
              ...
              },
              {
                name: 'Picket fence',
                description:
                  "Picket fences are distinguished by their evenly spaced vertical boards, the pickets are attached to horizontal rails.  Similar to the board fence the Picket Fence is constructed using Posts, Rails, but instead of using unspaced boards it uses decorative pickets evenly spaced. Usually 3-4' high but can also be 5-6' high. If damage is only to the paint or stain, it can be power washed and refinished for a proper repair. If unstained, no repair is necessary.",
            ...
            options: [
              {
                name: 'House wrap',
                description:
                  'House wraps prevent moisture that gets behind the siding from damaging the framing. It is also used to prevent drafts caused by wind entering through cracks or openings in the siding.',
                image: 'images/siding-wrap-components/wrap/house.webp',
              },
              {
                name: 'Foil Vapor Barrier',
                description:
                  'Foil Vapor Barriers prevent moisture that gets behind the siding from damaging the framing. It is also used to prevent drafts caused by wind entering through the cracks or openings in the siding. Foil Vapor Barriers also provides limited insulating effects.',
      ...
      },
      {
        ...
        description:
          'An “Other Structure” is detached from the main Dwelling, Other Structures may include but are not limited to detached garages that accommodate automobiles, sheds that house lawn or garden equipment, green houses or fencing of all types. A deck is NOT an “other structure” unless it is freestanding (Not physically attached to the Dwelling).',
            ...
            options: [
              {
                name: 'Porch/Patio',
                description:
                  'An outdoor area typically attached to the dwelling. Can be completely open or screened in. Commonly poured concrete. Dirt, loose gravel, and mosaic tiles are all flooring options. If not attached to dwelling would be considered a gazebo.',
                image: 'images/outdoor-structures/patio-cover.jpg',
              },
            ],
          },
    ...
    data: [
      {
        ...
        description:
          'A type of board made from plaster, wood pulp, or other material, used especially to form the interior walls and ceilings of houses. Drywall is mudded and taped at the joints.',
      ...
      },
      {
        ...
        description:
          'Flooring is the general term for a permanent covering of a floor. It is a crucial part of any interior design. There are many different types of floor coverings such as Pre-Finished Hardwood Flooring, Hardwood Flooring, Engineered Flooring, Vinyl, Tile, and Carpet.',
      ...
      },
      {
        ...
        description:
          'A style of trim generally used to cover the rough joint between the wall and ceiling, mostly made of wood material.',
      ...
      },
      {
        ...
        description:
          'It is a piece of wood trim that is placed at the bottom of the wall to cover up the rough joints where the wall and floor meet. Base molding may be referred to as one-, two- or three-piece members, which are Base Shoe, Baseboards, and Base Caps.',
      ...
      },
      {
        ...
        description:
          'It is a piece of Trim generally placed 2 1/2, 3 feet off the floor parallel to the floor, Chair rails would protect the walls from any moving furniture to prevent it from hitting against the wall.',
      ...
      },
      {
        ...
        description:
          'Ceiling lights are light fixtures that are mounted on ceilings or walls, there are different types of ceiling lights such as Recessed Lights, Downlights, Chandeliers, etc.',
