...
export const info: Item[] = [
  {
    ...
    description:
      'We chose laminated shingles to provide a more natural and deeper look than that ofered by a conventional 3-tab shingle. Laminated shingles have a manufacturer-specifed lifespan of 30 years, while 3-tab shingles have a manufacturer-specifed lifespan of 25 years. ',
    ...
    types: [
      {
        ...
        options: [
          ...
          },
          {
            name: 'Mansard',
            description:
              'A  mansard roof, type of roof having two slopes on every side, the lower slope being considerably steeper than the upper.',
  ...
  },
  {
    ...
    description:
      'We went for a vinyl siding (which is a plastic exterior siding) for decoration and weatherproofng. It was also pocket friendly and gave us the sturdiness we were looking for.',
  ...
  },
  {
    ...
    description:
      "We love how an overhead garage door works! It is a door that moves upward to an overhead position when opened. It's usually a series of hinged panels with rollers that move up and down on a metal track, used on garages.",
